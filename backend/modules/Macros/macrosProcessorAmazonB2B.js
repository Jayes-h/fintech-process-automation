 ...
 */
function applyFormulas(ws, sourceSheetName = 'Source', date = '') {
 ...
 */
async function processMacrosB2B(rawFileBuffer, skuFileBuffer, brandName, date, skuData = null, stateConfigData = null) {
  try {
    ...
    for (let rowNum = 2; rowNum <= lastRow; rowNum++) {
      ...
      // Manually calculate values for B2B
